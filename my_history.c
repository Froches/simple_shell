#include "shell.h"
/**
 * _get_history_file - function that gets the file history
...
/**
 * write_history - function that creates file or appends it to an existing file
 * @info: struct argument
 *
 ...
 * @info: struct argument
 *
 * Return: returns histcount if successful, 0 if otherwise
 */
